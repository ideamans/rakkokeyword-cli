...
// independent internal/gen-llmdocs program could not reach it without splitting
// the CLI into another package first.
func newGenerateCommand() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			md := catalog.Markdown(rootCmd, catalog.Options{
